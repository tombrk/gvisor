...
func openFSCheckpointLocalFiles(imagePath string, openFlags int, direct bool) ([]*os.File, error) {
	...
	manifestFilePath := filepath.Join(imagePath, fscheckpoint.ManifestFileName)
	...
	multiTarFilePath := filepath.Join(imagePath, fscheckpoint.MultiTarFileName)
	...
	pagesMetadataFilePath := filepath.Join(imagePath, fscheckpoint.PagesMetadataFileName)
	...
	pagesFilePath := filepath.Join(imagePath, fscheckpoint.PagesFileName)
